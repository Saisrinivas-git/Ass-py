'''
1. Write a python program to read the contents of a file and count the size of file then count how many times "CSE" is existed in the file
'''
import os
